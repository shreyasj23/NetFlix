        ...
        <footer className="hero">
          ...
          <div className="line_separete">
            <div className="by flex">
                <p style={{display:"flex"}}>Cpoyright <BsCCircle style={{margin:"5px 10px"}}/>2023 - {new Date().getFullYear()} All Rights are Reserved by <Link to="https://www.instagram.com/shreyasfeb23/" style={{marginLeft:"10px"}}>Shreyasfeb23</Link></p>
                <div className="icons">
                    <a href="https://www.instagram.com/shreyasfeb23/" className="icon1 icon--instagram">
                        <i><AiOutlineInstagram/></i>
                    </a>
                    <a href="https://www.twitter.com/shreyaj232" className="icon1 icon--twitter">
                        <i><AiOutlineTwitter/></i>
                    </a><a href="https://www.linkedin.com/in/shreyassjadhav/" className="icon1 icon--linkedin">
                        <i><AiOutlineLinkedin/></i>
                    </a>
                    <a href="https://github.com/shreyas232" className="icon1 icon--github">
                        <i><AiOutlineGithub/></i>
                    </a>
                </div>
            </div>
